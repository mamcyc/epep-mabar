...
webhook.embed1.thumbnail = "https://images-ext-1.discordapp.net/external/LPJQR4xeO2G6mibbSxNUbAaQHRjngUbQo8rJJBBGutY/https/cdn.discordapp.com/avatars/1204716269274800191/ec182a7a38fed23a6e31f15b2cf56d63.png?format=webp&quality=lossless"
webhook.embed1.footer.text = "Imam script | Find World\n"..os.date("!%b-%d-%Y, %I:%M %p", os.time() + 7 * 60 * 60)
if IDs ~= "" then
    webhook:edit(IDs)
else
    webhook:send()
